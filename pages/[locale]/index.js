...
function MoreAbout() {
  ...
  return <Fragment>
    ...
    <Typography align="left">
      BookMyTix web version demo. This template built with <strong>Flutter</strong> and support for <strong>Android, iOS, and Mobile Web.</strong>
    ...
    <Grid container spacing={1} className={classes.btnCta}>
      <Grid item xs={6}>
        <Button size="small" fullWidth variant="outlined" color="black" target="_blank" href="https://ilhammeidi.github.io/bookmytix-docs">
          <MenuBookIcon sx={{ mr: 0.5 }} /> Online Docs
        </Button>
      </Grid>
      <Grid item xs={6}>
        <Button size="small" fullWidth variant="outlined" color="black" target="_blank" href="https://themeforest.net/user/ilhammeidi">
    ...
    <Typography>
      ...
      <br />
      <a target="_blank" href="https://themeforest.net/user/ilhammeidi">https://themeforest.net/user/ilhammeidi</a>
    </Typography>
  </Fragment>
}
            ...
            <div className={cx(classes.phoneWrap, zoom == 'small' && classes.noscroll)}>
              <div className={cx(classes.phoneFrame, classes[zoom])}>
                <div className={classes.phoneContent}>
                  <iframe  width="100%" height="100%" src="https://bookmytixweb.vercel.app/"></iframe>
                </div>
              </div>
            </div>
          </Grid>
            ...
            <Grid item lg={3} xs={12}>
              <div className={classes.optZoom}>
                ...
                <ButtonGroup size="large" aria-label="Large button group">
                  <Button onClick={() => handleZoom('small')} variant={zoom == 'small' ? 'contained' : 'outlined'}>Small (50%)</Button>
                  <Button onClick={() => handleZoom('medium')} variant={zoom == 'medium' ? 'contained' : 'outlined'}>Medium (75%)</Button>
                  <Button onClick={() => handleZoom('large')} variant={zoom == 'large' ? 'contained' : 'outlined'}>Large (100%)</Button>
                </ButtonGroup>
                <br />
                <Button
                  fullWidth
                  href="https://bookmytixweb.vercel.app/"
                  target="_blank"
                  size="large"
                  variant="contained"
                  color="black"
